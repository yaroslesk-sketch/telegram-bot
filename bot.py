...
• доставка доступна в любой регион РФ
• срок доставки зависит от города получателя

Стоимость доставки:
💰 рассчитывается индивидуально в зависимости от города и выбранной службы доставки.

После оформления заказа мы сообщим точную стоимость и сроки доставки.

По всем вопросам вы можете связаться с нами:
📞 89025445443
тож самое как и в контактах"""
    )
